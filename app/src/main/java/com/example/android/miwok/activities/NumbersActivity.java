...
public class NumbersActivity extends AppCompatActivity {
    ...
    private AudioManager.OnAudioFocusChangeListener mOnAudioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT ||
                ...
                mMediaPlayer.pause();
                mMediaPlayer.seekTo(0); // Back to the beginning audio file.

            } else if (focusChange == AudioManager.AUDIOFOCUS_GAIN) {
                // The AUDIOFOCUS GAIN case means we have regained foucs and can resume playback.
                mMediaPlayer.start();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int result = mAudioManager.requestAudioFocus(mOnAudioFocusChangeListener,
                        ...
                        // Request short focus, for one or two seconds.
                        AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);

                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    // We have audio focus now with exit.
    ...
    protected void onStop() {
        ...
        // resources because we won't be playing any more sounds.
        releaseMediaPlayer();
    }
